   ...
   for( d = first_descriptor; d; d = d->next )
   {
	...
	if( person && d->connected >= CON_PLAYING )
	{
	   if( I3PERM(person) < I3PERM_MORT || I3PERM(person) >= I3PERM_IMM 
         ...
         {
            I3_write_buffer( "({\"" );
            send_to_i3( I3_escape( "&B--------------------------------=[ &WPlayers &B]=---------------------------------" ) );
            I3_write_buffer( "\"," );
            snprintf( smallbuf, 50, "%ld", bogusidle );
            I3_write_buffer( smallbuf );
            I3_write_buffer( ",\" \",})," );
   ...
   for( d = first_descriptor; d; d = d->next )
   {
	...
	if( person && d->connected >= CON_PLAYING )
	{
	   if( I3PERM(person) < I3PERM_IMM || I3ISINVIS(person) || i3ignoring( person, ibuf ) )
         ...
         {
            I3_write_buffer( "({\"" );
            send_to_i3( I3_escape( "&R-------------------------------=[ &WImmortals &R]=--------------------------------" ) );
            I3_write_buffer( "\"," );
	      if( xx > 0 )
...
I3_CMD( I3_mudinfo )
{
   ...
   if (mud->tell)	i3_to_char( "&wtell, ", ch );
   if (mud->beep)	i3_to_char( "&wbeep, ", ch );
   if (mud->emoteto)	i3_to_char( "&wemoteto, ", ch );
   if (mud->who)		i3_to_char( "&wwho, ", ch );
   if (mud->finger)	i3_to_char( "&wfinger, ", ch );
   if (mud->locate)	i3_to_char( "&wlocate, ", ch );
   if (mud->channel)	i3_to_char( "&wchannel, ", ch );
   if (mud->news)	i3_to_char( "&wnews, ", ch );
   if (mud->mail)	i3_to_char( "&wmail, ", ch );
   if (mud->file)	i3_to_char( "&wfile, ", ch );
   if (mud->auth)	i3_to_char( "&wauth, ", ch );
   if (mud->ucache)	i3_to_char( "&wucache, ", ch );
   i3_to_char( "\n\r", ch );

   i3_to_char( "&wSupports   : ", ch );
   if (mud->smtp)	i3_printf( ch, "&wsmtp (port %d), ", mud->smtp );
   if (mud->http)	i3_printf( ch, "&whttp (port %d), ", mud->http );
   if (mud->ftp)	i3_printf( ch, "&wftp  (port %d), ", mud->ftp );
   if (mud->pop3)	i3_printf( ch, "&wpop3 (port %d), ", mud->pop3 );
   if (mud->nntp)	i3_printf( ch, "&wnntp (port %d), ", mud->nntp );
   if (mud->rcp)	i3_printf( ch, "&wrcp  (port %d), ", mud->rcp );
   if (mud->amrcp)	i3_printf( ch, "&wamrcp (port %d), ",mud->amrcp );
   i3_to_char( "\n\r", ch );
}
   ...
   while( *format != '\0' )
   {
      ...
      else
      {
         switch( *format )
         {
            ...
            case 'k': one_argument( CH_I3NAME(ch), tmp_str ); i = (char *)tmp_str; break;
            case 'K': one_argument( CH_I3NAME(vic), tmp_str ); i = (char *)tmp_str; break;
            break;
         }
      }
      ++format;
...
char *i3_funcname( I3_FUN *func )
{
   if( func == I3_other )                 return( "I3_other" );
   if( func == I3_listen_channel )        return( "I3_listen_channel" );
   if( func == I3_chanlist )              return( "I3_chanlist" );
   if( func == I3_mudlist )               return( "I3_mudlist" );
   if( func == I3_invis )                 return( "I3_invis" );
   if( func == I3_who )                   return( "I3_who" );
   if( func == I3_locate )                return( "I3_locate" );
   if( func == I3_tell )                  return( "I3_tell" );
   if( func == I3_reply )                 return( "I3_reply" );
   if( func == I3_emote )                 return( "I3_emote" );
   if( func == I3_beep )                  return( "I3_beep" );
   if( func == I3_ignorecmd )             return( "I3_ignorecmd" );
   if( func == I3_finger )                return( "I3_finger" );
   if( func == I3_mudinfo )               return( "I3_mudinfo" );
   if( func == I3_color )                 return( "I3_color" );
   if( func == I3_afk )                   return( "I3_afk" );
   if( func == I3_chan_who )              return( "I3_chan_who" );
   if( func == I3_connect )               return( "I3_connect" );
   if( func == I3_disconnect )            return( "I3_disconnect" );
   if( func == I3_send_user_req )         return( "I3_send_user_req" );
   if( func == I3_permstats )             return( "I3_permstats" );
   if( func == I3_deny_channel )          return( "I3_deny_channel" );
   if( func == I3_permset )               return( "I3_permset" );
   if( func == I3_chanlayout )            return( "I3_chanlayout" );
   if( func == I3_admin_channel )         return( "I3_admin_channel" );
   if( func == I3_addchan )               return( "I3_addchan" );
   if( func == I3_removechan )            return( "I3_removechan" );
   if( func == I3_edit_channel )          return( "I3_edit_channel" );
   if( func == I3_mudlisten )             return( "I3_mudlisten" );
   if( func == I3_router )                return( "I3_router" );
   if( func == I3_bancmd )                return( "I3_bancmd" );
   if( func == I3_setconfig )             return( "I3_setconfig" );
   if( func == I3_setup_channel )         return( "I3_setup_channel" );
   if( func == I3_stats )                 return( "I3_stats" );
   if( func == I3_show_ucache_contents )  return( "I3_show_ucache_contents" );
   if( func == I3_debug )                 return( "I3_debug" );
   if( func == i3_hedit )                 return( "i3_hedit" );
   if( func == i3_help )                  return( "i3_help" );
   if( func == i3_cedit )                 return( "i3_cedit" );
...
I3_FUN *i3_function( const char *func )
{
   if( !strcasecmp( func, "I3_other" ) )                    return I3_other;
   if( !strcasecmp( func, "I3_listen_channel" ) )           return I3_listen_channel;
   if( !strcasecmp( func, "I3_chanlist" ) )                 return I3_chanlist;
   if( !strcasecmp( func, "I3_mudlist" ) )                  return I3_mudlist;
   if( !strcasecmp( func, "I3_invis" ) )                    return I3_invis;
   if( !strcasecmp( func, "I3_who" ) )                      return I3_who;
   if( !strcasecmp( func, "I3_locate" ) )                   return I3_locate;
   if( !strcasecmp( func, "I3_tell" ) )                     return I3_tell;
   if( !strcasecmp( func, "I3_reply" ) )                    return I3_reply;
   if( !strcasecmp( func, "I3_emote" ) )                    return I3_emote;
   if( !strcasecmp( func, "I3_beep" ) )                     return I3_beep;
   if( !strcasecmp( func, "I3_ignorecmd" ) )                return I3_ignorecmd;
   if( !strcasecmp( func, "I3_finger" ) )                   return I3_finger;
   if( !strcasecmp( func, "I3_mudinfo" ) )                  return I3_mudinfo;
   if( !strcasecmp( func, "I3_color" ) )                    return I3_color;
   if( !strcasecmp( func, "I3_afk" ) )                      return I3_afk;
   if( !strcasecmp( func, "I3_chan_who" ) )                 return I3_chan_who;
   if( !strcasecmp( func, "I3_connect" ) )                  return I3_connect;
   if( !strcasecmp( func, "I3_disconnect" ) )               return I3_disconnect;
   if( !strcasecmp( func, "I3_send_user_req" ) )            return I3_send_user_req;
   if( !strcasecmp( func, "I3_permstats" ) )                return I3_permstats;
   if( !strcasecmp( func, "I3_deny_channel" ) )             return I3_deny_channel;
   if( !strcasecmp( func, "I3_permset" ) )                  return I3_permset;
   if( !strcasecmp( func, "I3_admin_channel" ) )            return I3_admin_channel;
   if( !strcasecmp( func, "I3_bancmd" ) )                   return I3_bancmd;
   if( !strcasecmp( func, "I3_setconfig" ) )                return I3_setconfig;
   if( !strcasecmp( func, "I3_setup_channel" ) )            return I3_setup_channel;
   if( !strcasecmp( func, "I3_chanlayout" ) )               return I3_chanlayout;
   if( !strcasecmp( func, "I3_addchan" ) )                  return I3_addchan;
   if( !strcasecmp( func, "I3_removechan" ) )               return I3_removechan;
   if( !strcasecmp( func, "I3_edit_channel" ) )             return I3_edit_channel;
   if( !strcasecmp( func, "I3_mudlisten" ) )                return I3_mudlisten;
   if( !strcasecmp( func, "I3_router" ) )                   return I3_router;
   if( !strcasecmp( func, "I3_stats" ) )                    return I3_stats;
   if( !strcasecmp( func, "I3_show_ucache_contents" ) )     return I3_show_ucache_contents;
   if( !strcasecmp( func, "I3_debug" ) )                    return I3_debug;
   if( !strcasecmp( func, "i3_help" ) )                     return i3_help;
   if( !strcasecmp( func, "i3_cedit" ) )                    return i3_cedit;
   if( !strcasecmp( func, "i3_hedit" ) )                    return i3_hedit;
