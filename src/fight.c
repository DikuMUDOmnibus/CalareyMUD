...
void violence_update( void )
{
	...
	if ( char_died(ch) )
		continue;
                ...
                if (ch->speed < 0) ch->speed = 1;
                else if (ch->speed > 100) ch->speed--;
                else if (ch->speed < 100) ch->speed++;
